...
console.log("Aplicando find para buscar el primer taller de Ing. María L+opez");
...
console.log("Aplicando reduce para sumar todos los inscritos");
...
console.log("Aplicando filter + map para talleres con cupo disponible");
